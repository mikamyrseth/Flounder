...
namespace Flounder
{
  ...
  public struct Rectangle : IShape
  {
    ...
    public static Rectangle ParseJSO(dynamic JSON) { return new Rectangle(Vector2.ParseJSO(JSON.semiSize)); }
    ...
    public Rectangle(Vector2 semiSize) { this._semiSize = semiSize; }
